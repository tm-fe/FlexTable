...
describe('Flex-Table', () => {
    ...
    describe('sortable', () => {
        ...
        it('change columns: desc', async() => {
            ...
            const elemHeadDateSort = vm.$el.querySelector('.flex-table-head .flex-table-col:nth-child(4) .flex-table-sort .flex-table-arrow-dropdown');

            expect(elemHeadDateSort.classList.contains('on')).to.eql(true);
        });
        ...
        it('change columns: asc', async() => {
            ...
            const elemHeadDateSort = vm.$el.querySelector('.flex-table-head .flex-table-col:nth-child(4) .flex-table-sort .flex-table-arrow-dropup');
